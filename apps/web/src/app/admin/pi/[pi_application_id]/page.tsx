...
export default async function PIApplicationDetailPage({ params }: {
      ...
      <main>
        <header>
          ...
          <div>
            ...
            {" | "}
            <Link
              href={`/admin/user/${application.userId.toString()}`}
            >
              View User
            </Link>
          </div>
        ...
        <section>
          ...
          <div>
            ...
            {application.decidedBy
              ? application.decidedBy.toString()
              : "Not decided"}
          </div>
          <div>
